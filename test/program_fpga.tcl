...
# falls back to the graph_v1 build location.
if {[info exists env(BITFILE)]} {
    set bitfile $env(BITFILE)
} else {
    set bitfile "/home/chettige/research/open-nic-shell/build/au250_graph_v1/open_nic_shell/open_nic_shell.runs/impl_1/open_nic_shell.bit"
}
