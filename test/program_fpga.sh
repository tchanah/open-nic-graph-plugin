...
#   default bitfile: au250_graph_v1 impl_1 output
set -e

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
DEFAULT_BIT="/home/chettige/research/open-nic-shell/build/au250_graph_v1/open_nic_shell/open_nic_shell.runs/impl_1/open_nic_shell.bit"
